...
public class OutputFrame extends javax.swing.JFrame {
    ...
    public OutputFrame() {
        ...
        //TextAreaHeaderRenderer renderer = new TextAreaHeaderRenderer();
    ...
    public synchronized void setWord(int index,String pinyin,String desc,boolean isright){
        TableModel tm=jTable1.getModel();
        tm.setValueAt(pinyin, index, 1);
        tm.setValueAt(desc, index, 2);
    }
